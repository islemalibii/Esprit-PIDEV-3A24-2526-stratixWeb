 ...
 */
final class Version20260503195447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favori DROP FOREIGN KEY IF EXISTS FK_EF85A2CCFB88E14F');
        $this->addSql('ALTER TABLE favori DROP FOREIGN KEY IF EXISTS FK_EF85A2CCC18272');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE theme theme VARCHAR(255) DEFAULT \'light\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE theme theme VARCHAR(255) DEFAULT \'light\'');
    }
}
